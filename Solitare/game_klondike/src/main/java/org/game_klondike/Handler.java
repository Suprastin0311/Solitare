...
/**
 * Класс {@code Handler} обрабатывает действия, совершаемые игроком на поле игры "Косынка".
...
public class Handler {
    ...
    /**
     * Начинает новую игру в пасьянс "Косынка".
     */
    ...
    /**
     * Раздаёт карты на игровое поле в соответствии с правилами "Косынки".
     */
     ...
     *
     * @return {@code true}, если все карты разложены по домам; иначе {@code false}
     */
