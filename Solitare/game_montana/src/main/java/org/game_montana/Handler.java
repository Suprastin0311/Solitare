...
/**
 * Класс {@code Handler} обрабатывает действия, совершаемые игроком на поле игры "Montana".
...
public class Handler {
    ...
    /**
     * Начинает новую игру в пасьянс "Montana".
     */
     ...
     *
     * @return {@code true}, если все карты упорядочены по возрастанию; иначе {@code false}
     */
